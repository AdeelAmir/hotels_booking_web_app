<template>
  <section class="pt-3 pt-lg-5 mt-3">
    <b-container>
          ...
          <div class="hstack gap-4 flex-wrap align-items-center">
            ...
            >
              ...
              <div class="align-middle d-inline-block">
                <h6 class="fw-normal small mb-0">&nbsp;PriceRoom In 30 secs</h6>
              </div>
            </CustomGLightbox>
          </div>
        </b-col>
      ...
      <AvailabilityFilter  @searchData="handleData" />
    </b-container>
  </section>
</template>
...
import bg6 from '@/assets/images/bg/06.png'
