      ...
      <b-container>
        <b-row>
          <b-col lg="10" class="mx-auto text-center">
            ...
            <a class="icon-md btn2 btn btn-round btn-primary position-absolute top-50 end-0 translate-middle-y py-0" href="#"><svg width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" role="img" focusable="false" class="fa-fw"><path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"></path></svg></a>
            </b-form>
          </b-col>
        </b-row>
      </b-container>
