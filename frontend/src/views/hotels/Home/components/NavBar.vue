...
import { BIconBookmarkCheck, BIconPower, BIconSun, BIconMoonStars, BIconCircleHalf, BIconSearch, BIconList, BIconPersonCircle } from 'bootstrap-icons-vue'
...
console.log(useCurrencyData);
const isLoading = ref(false);
const error = ref('');
const showModal = ref(false);
const isDropdownOpen = ref(false);
const dropdown = ref();
const selectedCurrency = ref(useCurrencyData?.symbol || '$');
const selectedFlag = ref(useCurrencyData?.flag || 'https://flagcdn.com/w320/us.png');
