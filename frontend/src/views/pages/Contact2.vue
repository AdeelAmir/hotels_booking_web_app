        ...
        <b-row class="g-4">
          <b-col lg="6">
            ...
            <b-form class="mt-4">
              ...
              <div>
                <b-button size="lg" variant="primary" class="mb-0">Send Message</b-button>
              </div>
            </b-form>
          </b-col>

          <b-col lg="6" xl="5" class="text-center text-lg-end position-relative ms-auto">
            ...
            <img :src="about5Img" class="rounded-3 position-relative" alt="" />
          </b-col>
        </b-row>

        <b-row class="g-4 align-items-center mt-5">
          <b-col lg="4">
            ...
            <ul class="list-inline hstack flex-wrap gap-2 gap-lg-4 justify-content-lg-end h6 mb-0">
              ...
              <li class="list-inline-item">
                <a class="text-instagram-gradient" href="#">
                  <font-awesome-icon :icon="faInstagramSquare" style="color: rgb(250, 126, 30)" />
                  Instagram</a
                >
              </li>
              <li class="list-inline-item">
              ...
              <li class="list-inline-item">
                <a class="text-linkedin" href="#">
                  <font-awesome-icon :icon="faLinkedin" />
                  Linkedin</a
                >
              </li>
              <li class="list-inline-item">
                <a class="text-whatsapp" href="#">
                  <font-awesome-icon :icon="faWhatsappSquare" />
                  WhatsApp</a
                >
              </li>
            </ul>
    ...
    <section class="pt-0 pt-lg-5">
      <b-container>
        <b-row class="g-4">
          ...
          <b-col sm="6" lg="4">
            <b-card class="card-body shadow p-4 h-100">
...
import { about5Img } from '@/views/pages/data'
</script>
