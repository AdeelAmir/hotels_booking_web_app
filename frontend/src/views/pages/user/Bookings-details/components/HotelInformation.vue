              ...
              <b-col sm="6" md="6">
                <b-card-body class="pt-3 pt-sm-0 p-0">
                  ...
                  <ul class="list-inline mb-0 gap-1">
                    ...
                    <li class="list-inline-item ms-2 h6 small fw-bold mb-0">{{ hotelRating }}/5.0</li>
                  </ul>
                </b-card-body>
              </b-col>

              <b-col sm="6" md="3" >
                <b-button :disabled="isLoading" variant="primary" class="mt-2 btn-primary-soft" @click="showAlert"> Cancel
                  Now
                ...
                <b-button variant="primary" class="mt-2 ml-2 btn-primary-soft" @click="redirectUser"> Back
                  <BIconArrowLeft/>
                </b-button>
              </b-col>
            </b-row>
